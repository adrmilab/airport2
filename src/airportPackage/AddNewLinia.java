...
public class AddNewLinia extends JDialog {
    ...
    public AddNewLinia() {
        ...
        buttonOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    int aux = main.dodajLinieLotnicza(main.finalConn, liniaLotnicza);
                    setVisible(false);
                    if (aux == 1) {
                        JOptionPane.showMessageDialog(main, "Linia lotnicza dodana", "Dodawanie", JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    } else {
                        JOptionPane.showMessageDialog(main, "Nie udało się dodać linii lotniczej", "Błąd", JOptionPane.ERROR_MESSAGE);
                    }
    ...
    public static void main(String[] args) {
        AddNewLinia dialog = new AddNewLinia();
        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        nazwatextField.setToolTipText("Wprowadź nazwę");
