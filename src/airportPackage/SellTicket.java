...
public class SellTicket extends JDialog {
    private JPanel contentPane;
    private JButton buttonOK;
    private JButton buttonCancel;
    private JLabel sprzedaz;
...
//    }
    ...
    //kod modyfikowania
    public SellTicket(Main main1, Integer biletid) {
        main1 = main;
        ...
        List<Pasazer> pasazerowie = main.wypiszPasazerow(main.finalConn);
        for (int i = 0; i < pasazerowie.size(); i++) {
            comboBox1.addItem(pasazerowie.get(i).getPesel() + " " + pasazerowie.get(i).getImie() + " " + pasazerowie.get(i).getNazwisko());
        }
        ...
        buttonOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    int aux = main.modyfikujBilet(main.finalConn, String.valueOf(biletid), comboBox1.getSelectedItem().toString().substring(0, 11));
                    setVisible(false);
                    if (aux == 1) {
                        JOptionPane.showMessageDialog(main, "Bilet sprzedany", "Sprzedaż", JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    } else {
                        JOptionPane.showMessageDialog(main, "Nie udało się sprzedać biletu", "Błąd", JOptionPane.ERROR_MESSAGE);
                    }
...
//        SellTicket dialog = new SellTicket();
//        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        sprzedaz = new JLabel();
        sprzedaz.setText("Sprzedaż biletu");
        contentPane.add(sprzedaz, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
